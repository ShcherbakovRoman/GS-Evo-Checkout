# Created by rshche at 12/8/20
Feature: Test eSW Checkout UX for Switzerland Countries in Test Environment
  ...
  Scenario: Evo Checkout UX is invoked
    ...
    And Select country - Switzerland
  ...
  Scenario: Verify if the SLSQ order can be placed
    ...
    And Select delivery method - Express
